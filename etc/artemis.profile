...
ARTEMIS_HOME='/opt/RH/amq-broker-7.2.3'
ARTEMIS_INSTANCE='/opt/RH/amq-broker-7.2.3/instances/starman'
ARTEMIS_DATA_DIR='/opt/RH/amq-broker-7.2.3/instances/starman/data'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/opt/RH/AMQ-7/instances/starman/'
ARTEMIS_INSTANCE_ETC_URI='file:/opt/RH/AMQ-7/instances/starman/etc/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+AggressiveOpts -XX:+UseFastAccessorMethods -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.role=Administrator -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
